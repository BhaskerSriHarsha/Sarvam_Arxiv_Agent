...
2. LITERATURE SEARCH: Use the `search_papers` tool to find the most relevant and recent papers. Review the titles and abstracts provided in the search results.
